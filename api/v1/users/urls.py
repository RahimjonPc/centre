...
from .views import LeaderView, TeachersListView, StudentListView, TeacherCreateView, TeacherPasswordUpdateView, StudentCreateView, StudentUpdateView, StudentGroupListView, StudentGroupCreateView, LoginView, MyTokenObtainPairView
